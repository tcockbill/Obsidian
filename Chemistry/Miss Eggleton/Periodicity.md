...
---
---  
# The [[../Definitions/Periodic Table|periodic table]]  
All elements are arranged by increasing atomic number  
## Groups  
->Columns  
->Same number of electrons on the outer shell, resulting in similar chemical properties  
  
## Period  
->Rows  
->Gives the number of the highest occupied [[../../Physics/Electron|electron]] shell  
  
## Periodicity  
This is the trend in chemical and physical properties repeated across each period  
  
## [[../../Physics/Electron|Electron]] Configuration  
->Across the periods 2 and 3   
	-> the s-subshell fills, followed by the p-subshells  
->Down the group  
	->Same number of outer electrons, just with an extra shell  
  
# [[../Definitions/Periodic Table|Periodic table]]  
...
# Ionisation energy  
[[./First ionisation energy|First ionisation energy]] -> The energy needed to remove one [[../../Physics/Electron|electron]] from one mole of gaseous atoms, forming one mole of gaseous 1+ ions  
Or:  
How easily an atom loses electrons to form positive ions  
  
We show this as:  
Na$_{(g)}$->Na$^+\space_{(g)}$+ e$^-$  
  
# Factors affecting ionisation energies  
The outer [[../../Physics/Electron|electron]] is always lost first due to having a weaker electrostatic attraction to the nucleus (and therefore a lower IE)  
Factors affecting IE values:  
- Atomic radius  
- Nuclear [[../../To do/Charge|charge]]  
- [[../../Physics/Electron|Electron]] shielding  
  
| Down the group               | Across the period            |  
| ---------------------------- | ---------------------------- |  
| Atomic radius increases      | Atomic radius decreases      |  
| Nuclear [[../../To do/Charge|charge]] increases     | Nuclear [[../../To do/Charge|charge]] increases     |  
| Shielding increases          | Shielding stays the same     |  
| Nuclear attraction decreases | Nuclear attraction increases |  
| Ionisation energy decreases  | Ionisation energy increases  |  
  
## Trends of ionisation energy  
- General increases across the period  
- Sharp decrease at the start of the next period  
- Dips seen between group 2/3 and group 5/6 elements  
  
![[../../Extra Files/Pasted image 20250113140437.png|Pasted image 20250113140437.png]]  
  
![[../../Extra Files/Pasted image 20250113140453.png|Pasted image 20250113140453.png]]  
